...
<section class="admin__panel__content-section">
    <form action="{{ route('admin.add_map_project' , ['id'=>$region_id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="section__name__elements">
            <div class="section__name__name section__name__name_link">
                <a href="{{ route('admin.map_element', ['id'=>$region_id]) }}">
            ...
            @endif
            <div class="section__map__region">
                Выбранный регион: {{ $region_id }}
                <input type="number" style="display: none; visibility:hidden;" value="{{$region_id}}" name="region_id" id="region_id">
            </div>
