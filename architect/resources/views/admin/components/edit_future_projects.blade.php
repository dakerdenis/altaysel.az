...
<section class="admin__panel__content-section">
    <form action="{{ route('admin.edit__future_project__form', ['id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="section__add__wrapper">
            ...
            <div class="section__add__photos section__add__photos-project">
                ...
                <a href="{{ route('admin.edit__additional_images__future', ['id' => $project->id]) }}" class="editing__additional__images">
