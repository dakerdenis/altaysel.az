            ...
            <section class="admin__panel__content-section">
                ...
                @endif
                    ...
                    <div class="section__element__search_add">
                        <div class="section__element__search">
                            <form action="#" method="POST">
                                @csrf
                                <input type="text" name="name" id="name" placeholder="Ada görə axtarış">

                                <button type="submit">
                                    <img src="{{ asset('style/imgs/search.svg') }}" alt="">
                                </button>
                        ...
                        <a href="{{ route('admin.main', ['content' => 'new_project']) }}" class="section__element__add">
                    ...
                    <div id="deleteConfirmationModal{{ $project->id }}" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-buttons">
                                <form action="{{ route('admin.delete_project', $project->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
