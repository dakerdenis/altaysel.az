...
<section class="admin__panel__content-section">
    ...
    <div class="section__name__elements">
        <div class="section__name__name section__name__name_link">
            <a href="{{ route('admin.main', ['content' => 'map']) }}">
        ...
        <a href="{{ route('admin.new_map_project', ['id' => $region_id]) }}"
            class="section__element__add">
            ...
            <div id="deleteConfirmationModal{{ $project->id }}" class="modal">
                <div class="modal-content">
                    ...
                    <div class="modal-buttons">
                        <form action="{{ route('admin.delete_map_project', $project->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
