...
<section class="admin__panel__content-section">
    <form action="{{route('admin.edit_map_project_form',  ['id' => $project->id])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="section__add__wrapper">
            ...
            <div class="section__add__photos section__add__photos-project">
                    ...
                    <div class="additional__photo__block">
                        @if ($i < count($additionalImages))
                            <div id="additional_photo_wrapper_{{ $i + 1 }}"
                                ...
                                <!-- Photo Container -->
                                <div style="background-image: url('{{ asset('uploads/projects/' . $additionalImages[$i]) }}')"
                ...
                <a href="{{route('admin.edit__additional_images__map' , ['project_id' => $project->id])}}" class="editing__additional__images">
