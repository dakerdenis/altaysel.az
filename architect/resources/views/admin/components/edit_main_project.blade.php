...
<section class="admin__panel__content-section">
    <form action="{{ route('admin.edit_main_project__form', ['id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="section__add__photos section__add__photos-project">
                <div class="main__photo__block">
                    <div id="add_photo_wrapper" class="add__photo__element">
                        ...
                        <!-- File Input -->
                        <input type="file" id="photo_input" name="main_photo" class="photo_input" accept="image/*">
                    </div>
                ...
                @php
                    $additionalImages = json_decode($project->images, true) ?? []; // Decode the JSON string to an array or default to an empty array
                @endphp

                @foreach ($additionalImages as $index => $image)
                    <div class="additional__photo__block">
                        <div id="additional_photo_wrapper_{{ $index + 1 }}" class="add__photo__element add__photo__element-small">
                            <!-- Delete Button -->
                            ...
                            <div style="background-image: url('{{ asset('./archi/public/uploads/projects/' . $image) }}')"
                                ...
                                <!-- Uploaded Image -->
                                <img class="uploaded_image" src="{{ asset('style/imgs/Camera.svg') }}" alt="Upload Photo">
                            </div>
                            <!-- File Input -->
                            <input type="file" id="photo_input_{{ $index + 1 }}" name="additional_photo_input[]" class="photo_input" accept="image/*">
                        </div>
                        <div class="error-image" style="color: #d37171;">
                            <!-- Error message will be displayed here -->
                        </div>
                ...
                @for ($i = count($additionalImages); $i < 4; $i++)
                    <div class="additional__photo__block">
                        <div id="additional_photo_wrapper_{{ $i + 1 }}" class="add__photo__element add__photo__element-small">
                            ...
                            <!-- Photo Container -->
                            <div class="add__photo__element-image add_photo__project-small" id="additional_photo_container_{{ $i + 1 }}">
                                <!-- Uploaded Image -->
                                <img class="uploaded_image" id="uploaded_image_{{ $i + 1 }}" src="{{ asset('style/imgs/Camera.svg') }}" alt="Upload Photo">
                                <!-- Default Image (Placeholder) -->
                                <img class="default_image" src="{{ asset('style/imgs/Camera.svg') }}" alt="Placeholder">
                            </div>
                            <!-- File Input -->
                            <input type="file" id="photo_input_{{ $i + 1 }}" name="additional_photo_input[]" class="photo_input" accept="image/*">
                        </div>
                        <div class="error-image" style="color: #d37171;">
                            <!-- Error message will be displayed here -->
                        </div>
                ...
                <a href="{{ route('admin.edit__additional_images__main', ['id' => $project->id]) }}" class="editing__additional__images">
            ...
            <div class="section__add_name">
                ...
                <div class="section__add__date">
                    <div class="input__container">
                        ...
                        <div class="input__field">
                            <input type="text" id="project__location" name="project__location" value="{{ $project->location }}"
            ...
            <div class="section__add_name">
                <div class="section__add__date">
                    <div class="input__container">
                        ...
                        <div class="input__field">
                            <input type="text" id="adress" name="adress" value="{{ $project->adress }}" required>
                        </div>
                    </div>
                    <p style="display: none">Обязательное поле не заполнено</p>
                </div>
            ...
            <br><br>
                        ...
                        <div class="section__add__youtube__link">
                            <div class="input__container">
                                ...
                                <div class="input__field">
                                    <input type="text" id="project__video_link" value="{{ $project->video_url }}" name="project__video_link"
